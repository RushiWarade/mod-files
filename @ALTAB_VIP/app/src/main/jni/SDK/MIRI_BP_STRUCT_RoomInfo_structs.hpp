...
struct FBP_STRUCT_RoomInfo
{
	...
	int                                                max_room_ob_20_16FCAC002BCC6942460B460B0DFA94C2;          // 0x0078(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                max_room_player_21_1DC83B0073BB18307744DF48010F7552;      // 0x007C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                ob_count_22_5C33DDC0377DAA4963EFB49306D721F4;             // 0x0080(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x0084(0x0004) MISSED OFFSET
	struct FString                                     room_type_24_266B9F0075F7E04210019EBD0EE218E5;            // 0x0088(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	bool                                               is_anchor_ob_25_7DD701001F30DB8C55869EA6022DBD52;         // 0x0098(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
