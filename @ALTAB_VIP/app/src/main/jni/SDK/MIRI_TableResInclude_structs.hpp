...
struct FItem_TabRes
{
	...
	struct FString                                     ArmorySimpleDesc;                                         // 0x0198(0x0010) (ZeroConstructor)
	struct FString                                     ArmoryDesc;                                               // 0x01A8(0x0010) (ZeroConstructor)
	struct FString                                     ItemSmallIcon2;                                           // 0x01B8(0x0010) (ZeroConstructor)
	struct FString                                     ItemBigIcon2;                                             // 0x01C8(0x0010) (ZeroConstructor)
	struct FString                                     BackpackSimple;                                           // 0x01D8(0x0010) (ZeroConstructor)
	int                                                UseType;                                                  // 0x01E8(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                gender;                                                   // 0x01EC(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                ArmoryJumpId;                                             // 0x01F0(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                CharmValue;                                               // 0x01F4(0x0004) (ZeroConstructor, IsPlainOldData)
};
