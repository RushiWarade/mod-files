...
struct FBP_STRUCT_CommonItemData
{
	...
	bool                                               isIsolated_23_53DEDE0061EB48F44575C38F03E37894;           // 0x0048(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0049(0x0003) MISSED OFFSET
	int                                                useCount_24_6D042F4050C524292F66FFB40FB3EB64;             // 0x004C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               isRolewear_25_171761001E1B031836B1EA900FAD2532;           // 0x0050(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0051(0x0003) MISSED OFFSET
	int                                                color_id_26_7CFA8C802CE551E046742CFF041E0584;             // 0x0054(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                pattern_id_27_24C2C4404642963D7D562E77014ABB64;           // 0x0058(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
