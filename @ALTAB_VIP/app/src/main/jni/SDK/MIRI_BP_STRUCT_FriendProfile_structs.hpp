...
struct FBP_STRUCT_FriendProfile
{
	...
	bool                                               isPlatFriend_65_02B938C051A9222B336584890B9AEA64;         // 0x0160(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0161(0x0003) MISSED OFFSET
	int                                                expertArea_2_66_04551000110141DE0F08D60A0A0DBB12;         // 0x0164(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                expertArea_1_67_04540FC0110141DD0F08D6150A0DBB11;         // 0x0168(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               isInnerFriendNotPlatFriend_68_55C0FA000153957C4D5C761D0D9BE374;// 0x016C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x016D(0x0003) MISSED OFFSET
	int                                                cityId_69_69840100347EAE364900D8C002EADD54;               // 0x0170(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                playTime_70_41A578C04F612A657110D3C208EE0D05;             // 0x0174(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               isFriend_71_4B6AB48066DA512A21CE41DC0DB85904;             // 0x0178(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x3];                                       // 0x0179(0x0003) MISSED OFFSET
	int                                                distance_72_38569A407164180F4A844BDC0ACAE665;             // 0x017C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                tendency_73_7E703E003F9FDDA02180B4CA022A2749;             // 0x0180(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x4];                                       // 0x0184(0x0004) MISSED OFFSET
	struct FString                                     signature_74_1C7DFC006DD404FE2FA177C40C4281D5;            // 0x0188(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	int                                                playDate_75_26379480654FEC1671E60C9808ED0B95;             // 0x0198(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                game_mode_76_1314EF00239B2AE01B6FF37805C02C45;            // 0x019C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FString                                     gameModeStr_77_65EB7D80611DC71070757D490A734F12;          // 0x01A0(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	int                                                history_max_segment_level_78_1FC4678039E29A9C1EA3C03708F1C63C;// 0x01B0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                relation_79_591EDF0035C6A04A7754414302480D9E;             // 0x01B4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                upass_is_show_87_46F969400B6548F53B1B76E208583E17;        // 0x01B8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                upass_is_buy_88_6C74AD0015D22EF45958A8E20785B3F9;         // 0x01BC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                recentLikeUID_100_578A818020DA900A095351940EFE6614;       // 0x01C0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                recentLikeTs_101_29BBDAC06308F221381A15670CEFE643;        // 0x01C4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                recentLikeOp_102_3EA078C019E97DC3381A14F80CEFE690;        // 0x01C8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x4];                                       // 0x01CC(0x0004) MISSED OFFSET
	struct FString                                     roleNation_103_6FB54E406637DBD302C87AB10AEB501E;          // 0x01D0(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	struct FString                                     language_104_58C778805B8426CC2E5F2F680E2E14B5;            // 0x01E0(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	int                                                enableWatch_105_3068DF00134D8B28033AC410089D6B08;         // 0x01F0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x4];                                       // 0x01F4(0x0004) MISSED OFFSET
	struct FString                                     aliasTitle_106_06C72A8035D542BC236DDE57082943B5;          // 0x01F8(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	int                                                upass_keep_buy_107_6DB23F4078AACED1093C9ADC07306E59;      // 0x0208(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x4];                                       // 0x020C(0x0004) MISSED OFFSET
	struct FString                                     aliasNation_108_6F7044403643E181163437190E6C27DE;         // 0x0210(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	int                                                aliasId_109_070B954014D17B371B10BAC704898DD4;             // 0x0220(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                gameSubMode_110_1A2139C07FE5268D4558F0E100A0E005;         // 0x0224(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                watchUid_111_08B0B5C06F6DE54971E3851702C97864;            // 0x0228(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
