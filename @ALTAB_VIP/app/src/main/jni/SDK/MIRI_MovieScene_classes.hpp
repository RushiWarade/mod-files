...
{
public:
	TArray<struct FMovieSceneSpawnable>                Spawnables;                                               // 0x0060(0x0010) (ZeroConstructor)
	TArray<struct FMovieScenePossessable>              Possessables;                                             // 0x0070(0x0010) (ZeroConstructor)
	TArray<struct FMovieSceneBinding>                  ObjectBindings;                                           // 0x0080(0x0010) (ZeroConstructor)
	TArray<class UMovieSceneTrack*>                    MasterTracks;                                             // 0x0090(0x0010) (ExportObject, ZeroConstructor)
	class UMovieSceneTrack*                            CameraCutTrack;                                           // 0x00A0(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	struct FFloatRange                                 SelectionRange;                                           // 0x00A8(0x0010)
	struct FFloatRange                                 PlaybackRange;                                            // 0x00B8(0x0010)
	bool                                               bForceFixedFrameIntervalPlayback;                         // 0x00C8(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00C9(0x0003) MISSED OFFSET
	float                                              FixedFrameInterval;                                       // 0x00CC(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              InTime;                                                   // 0x00D0(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	float                                              OutTime;                                                  // 0x00D4(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	float                                              StartTime;                                                // 0x00D8(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	float                                              endTime;                                                  // 0x00DC(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
...
{
public:
	struct FMovieSceneTrackEvalOptions                 EvalOptions;                                              // 0x0060(0x0004) (Edit)
...
{
public:
	struct FMovieSceneSectionEvalOptions               EvalOptions;                                              // 0x0060(0x0002) (Edit)
	unsigned char                                      UnknownData00[0x6];                                       // 0x0062(0x0006) MISSED OFFSET
	struct FMovieSceneEasingSettings                   Easing;                                                   // 0x0068(0x0038) (Edit)
	float                                              StartTime;                                                // 0x00A0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              endTime;                                                  // 0x00A4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      bIsInfinite : 1;                                          // 0x00B0(0x0001) (Edit)
	unsigned char                                      UnknownData01[0x3];                                       // 0x00B1(0x0003) MISSED OFFSET
	float                                              PrerollTime;                                              // 0x00B4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              PostrollTime;                                             // 0x00B8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FOptionalMovieSceneBlendType                BlendType;                                                // 0x00BC(0x0002)
...
{
public:
	struct FCachedMovieSceneEvaluationTemplate         EvaluationTemplate;                                       // 0x0060(0x0220)
	struct FMovieSceneTrackCompilationParams           TemplateParameters;                                       // 0x0280(0x0002)
	unsigned char                                      UnknownData00[0x6];                                       // 0x0282(0x0006) MISSED OFFSET
	TMap<class UObject*, struct FCachedMovieSceneEvaluationTemplate> InstancedSubSequenceEvaluationTemplates;                  // 0x0288(0x0050) (ZeroConstructor)
	bool                                               bParentContextsAreSignificant;                            // 0x02D8(0x0001) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	TEnumAsByte<EMovieScenePlayerStatus>               Status;                                                   // 0x03D8(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bReversePlayback : 1;                                     // 0x03D9(0x0001)
	unsigned char                                      bPendingFirstUpdate : 1;                                  // 0x03D9(0x0001)
	...
	unsigned char                                      UnknownData04[0x338];                                     // 0x0430(0x0338) MISSED OFFSET
