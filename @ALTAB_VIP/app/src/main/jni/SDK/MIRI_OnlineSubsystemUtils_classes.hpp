...
// 0x0068 (0x337C8 - 0x33760)
class UIpConnection : public UNetConnection
{
public:
	unsigned char                                      UnknownData00[0x68];                                      // 0x33760(0x0068) MISSED OFFSET
...
{
public:
	uint32_t                                           MaxPortCountToTry;                                        // 0x06C0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData00[0x1C];                                      // 0x06C4(0x001C) MISSED OFFSET
	uint32_t                                           ServerDesiredSocketReceiveBufferBytes;                    // 0x06E0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           ServerDesiredSocketSendBufferBytes;                       // 0x06E4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           ClientDesiredSocketReceiveBufferBytes;                    // 0x06E8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           ClientDesiredSocketSendBufferBytes;                       // 0x06EC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x60];                                      // 0x06F0(0x0060) MISSED OFFSET
	float                                              RecreateSocketCooldownTime;                               // 0x0750(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              RecreateSocketMaxTryCount;                                // 0x0754(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bResolveRemoteHostOnRecreateSocket;                       // 0x0758(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bContinueProcessWhenReceiveEmptyPackets;                  // 0x0759(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bContinueProcessWhenConReceiveEmptyPackets;               // 0x075A(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData02[0x5];                                       // 0x075B(0x0005) MISSED OFFSET
...
public:
	...
	float                                              BeaconConnectionInitialTimeout;                           // 0x0398(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              BeaconConnectionTimeout;                                  // 0x039C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	class UNetDriver*                                  NetDriver;                                                // 0x03A0(0x0008) (ZeroConstructor, IsPlainOldData)
...
{
public:
	class AOnlineBeaconHostObject*                     BeaconOwner;                                              // 0x03B8(0x0008) (ZeroConstructor, IsPlainOldData)
	class UNetConnection*                              BeaconConnection;                                         // 0x03C0(0x0008) (ZeroConstructor, IsPlainOldData)
	EBeaconConnectionState                             ConnectionState;                                          // 0x03C8(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
public:
	int                                                ListenPort;                                               // 0x03B8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x03BC(0x0004) MISSED OFFSET
	TArray<class AOnlineBeaconClient*>                 ClientActors;                                             // 0x03C0(0x0010) (ZeroConstructor)
...
{
public:
	struct FString                                     BeaconTypeName;                                           // 0x0390(0x0010) (ZeroConstructor, Transient)
	class UClass*                                      ClientBeaconActorClass;                                   // 0x03A0(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<class AOnlineBeaconClient*>                 ClientActors;                                             // 0x03A8(0x0010) (ZeroConstructor)
...
public:
	...
	struct FString                                     DestSessionId;                                            // 0x0428(0x0010) (ZeroConstructor)
	struct FPartyReservation                           PendingReservation;                                       // 0x0438(0x0030)
	EClientRequestType                                 RequestType;                                              // 0x0468(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData01[0x2D];                                      // 0x046B(0x002D) MISSED OFFSET
...
{
public:
	class UPartyBeaconState*                           State;                                                    // 0x03B8(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x50];                                      // 0x03C0(0x0050) MISSED OFFSET
	bool                                               bLogoutOnSessionTimeout;                                  // 0x0410(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0411(0x0003) MISSED OFFSET
	float                                              SessionTimeoutSecs;                                       // 0x0414(0x0004) (ZeroConstructor, Transient, Config, IsPlainOldData)
	float                                              TravelSessionTimeoutSecs;                                 // 0x0418(0x0004) (ZeroConstructor, Transient, Config, IsPlainOldData)
