...
struct FUTAddedSkillSturct
{
	...
	struct FString                                     SkillTemplatePath;                                        // 0x0028(0x0010) (Edit, BlueprintVisible, ZeroConstructor, EditConst)
	int                                                SkillIndex;                                               // 0x0038(0x0004) (Edit, BlueprintVisible, ZeroConstructor, EditConst, IsPlainOldData)
