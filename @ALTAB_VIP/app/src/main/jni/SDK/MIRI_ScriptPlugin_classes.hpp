...
{
public:
	class ULuaStateWrapper*                            OwningLuaStateWrapper;                                    // 0x0390(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	class UObject*                                     OwningObject;                                             // 0x0398(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	class UScriptContextComponent*                     ScriptContextComponent;                                   // 0x03A0(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
{
public:
	TArray<unsigned char>                              ByteCode;                                                 // 0x00F8(0x0010) (ZeroConstructor)
	struct FString                                     SourceCode;                                               // 0x0108(0x0010) (ZeroConstructor)
...
{
public:
	struct FString                                     TestString;                                               // 0x0390(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	float                                              TestValue;                                                // 0x03A0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               TestBool;                                                 // 0x03A4(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
