...
public:
	...
	unsigned char                                      bStopAILogicOnUnposses : 1;                               // 0x0430(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bLOSflag : 1;                                             // 0x0430(0x0001)
	unsigned char                                      bSkipExtraLOSChecks : 1;                                  // 0x0430(0x0001)
	unsigned char                                      bAllowStrafe : 1;                                         // 0x0430(0x0001)
	unsigned char                                      bWantsPlayerState : 1;                                    // 0x0430(0x0001)
	unsigned char                                      bSetControlRotationFromPawnOrientation : 1;               // 0x0430(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData01[0x7];                                       // 0x0431(0x0007) MISSED OFFSET
	class UPathFollowingComponent*                     PathFollowingComponent;                                   // 0x0438(0x0008) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UBrainComponent*                             BrainComponent;                                           // 0x0440(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UAIPerceptionComponent*                      PerceptionComponent;                                      // 0x0448(0x0008) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UPawnActionsComponent*                       ActionsComp;                                              // 0x0450(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UBlackboardComponent*                        Blackboard;                                               // 0x0458(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UGameplayTasksComponent*                     CachedGameplayTasksComponent;                             // 0x0460(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UClass*                                      DefaultNavigationFilterClass;                             // 0x0468(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FScriptMulticastDelegate                    ReceiveMoveCompleted;                                     // 0x0470(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData02[0x1];                                       // 0x0480(0x0001) MISSED OFFSET
	bool                                               UseGameplayTasksComponent;                                // 0x0481(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	class UNavMovementComponent*                       MovementComp;                                             // 0x0178(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData01[0x8];                                       // 0x0180(0x0008) MISSED OFFSET
	class ANavigationData*                             MyNavData;                                                // 0x0188(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData02[0x170];                                     // 0x0190(0x0170) MISSED OFFSET
...
public:
	...
	struct FVector                                     CrowdAgentMoveDirection;                                  // 0x0308(0x000C) (IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0314(0x0004) MISSED OFFSET
	class UCharacterMovementComponent*                 CharacterMovement;                                        // 0x0318(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	struct FNavAvoidanceMask                           AvoidanceGroup;                                           // 0x0320(0x0004) (Deprecated, IsPlainOldData)
	struct FNavAvoidanceMask                           GroupsToAvoid;                                            // 0x0324(0x0004) (Deprecated, IsPlainOldData)
	struct FNavAvoidanceMask                           GroupsToIgnore;                                           // 0x0328(0x0004) (Deprecated, IsPlainOldData)
	unsigned char                                      UnknownData02[0x24];                                      // 0x032C(0x0024) MISSED OFFSET
...
public:
	...
	TEnumAsByte<EEnvQueryRunMode>                      QueryingMode;                                             // 0x080A(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	class UNavLocalGridManager*                        GridManager;                                              // 0x0300(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
