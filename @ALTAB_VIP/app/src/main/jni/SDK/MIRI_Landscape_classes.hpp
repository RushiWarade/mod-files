...
// 0x0388 (0x0718 - 0x0390)
class ALandscapeProxy : public AActor
{
public:
	class ULandscapeSplinesComponent*                  SplineComponent;                                          // 0x0390(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	struct FGuid                                       LandscapeGuid;                                            // 0x0398(0x0010) (IsPlainOldData)
	struct FIntPoint                                   LandscapeSectionOffset;                                   // 0x03A8(0x0008) (IsPlainOldData)
	int                                                MaxLODLevel;                                              // 0x03B0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              LODDistanceFactor;                                        // 0x03B4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                ForceLOD;                                                 // 0x03B8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ELandscapeLODFalloff>                  LODFalloff;                                               // 0x03BC(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x03BD(0x0003) MISSED OFFSET
	int                                                OccluderGeometryLOD;                                      // 0x03C0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      bCacheHeightData : 1;                                     // 0x03D4(0x0001) (Edit)
	...
	unsigned char                                      bOverrideGrassTypes : 1;                                  // 0x03E8(0x0001) (Edit)
	unsigned char                                      UnknownData02[0x7];                                       // 0x03E9(0x0007) MISSED OFFSET
	TArray<class ULandscapeGrassType*>                 GrassTypes;                                               // 0x03F0(0x0010) (Edit, ZeroConstructor)
	...
	unsigned char                                      UnknownData03[0x60];                                      // 0x0438(0x0060) MISSED OFFSET
	...
	unsigned char                                      UnknownData05[0x1];                                       // 0x04A3(0x0001) MISSED OFFSET
	...
	struct FBodyInstance                               BodyInstance;                                             // 0x04D0(0x0190) (Edit, BlueprintVisible, BlueprintReadOnly)
	...
	ENavDataGatheringMode                              NavigationGeometryGatheringMode;                          // 0x0671(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bUseLandscapeForCullingInvisibleHLODVertices;             // 0x0672(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0xA5];                                      // 0x0673(0x00A5) MISSED OFFSET
...
public:
	...
	struct FOverridePhyxMaterial                       OverridePhyxMaterial;                                     // 0x0668(0x0020) (Edit)
	unsigned char                                      bOverrideGrassTypes : 1;                                  // 0x0688(0x0001) (Edit)
	unsigned char                                      UnknownData01[0x7];                                       // 0x0689(0x0007) MISSED OFFSET
	TArray<class ULandscapeGrassType*>                 GrassTypes;                                               // 0x0690(0x0010) (Edit, ZeroConstructor)
	TArray<class UMaterialInstanceConstant*>           MaterialInstances;                                        // 0x06A0(0x0010) (ZeroConstructor)
	...
	class UTexture2D*                                  XYOffsetmapTexture;                                       // 0x06D0(0x0008) (ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData03[0xC];                                       // 0x06F4(0x000C) MISSED OFFSET
	...
	TArray<class UTexture2D*>                          MobileWeightmapTextures;                                  // 0x07C8(0x0010) (ZeroConstructor)
	...
	unsigned char                                      UnknownData06[0x30];                                      // 0x07F0(0x0030) MISSED OFFSET
...
public:
	...
	struct FOverridePhyxMaterial                       OverridePhyxMaterial;                                     // 0x06C0(0x0020)
	unsigned char                                      UnknownData01[0x10];                                      // 0x06E0(0x0010) MISSED OFFSET
	TArray<class UPhysicalMaterial*>                   CookedPhysicalMaterials;                                  // 0x06F0(0x0010) (ZeroConstructor)
...
{
public:
	struct FGuid                                       MeshGuid;                                                 // 0x0740(0x0010) (IsPlainOldData)
...
{
public:
	class ULandscapeMeshProxyComponent*                LandscapeMeshProxyComponent;                              // 0x0390(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
...
{
public:
	TLazyObjectPtr<class ALandscape>                   LandscapeActor;                                           // 0x0718(0x001C) (Edit, IsPlainOldData)
