...
{
public:
	class UUAEStateMachineComponent*                   UAEStateMachineComponent;                                 // 0x0390(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
