...
public:
	...
	unsigned char                                      Shuffle : 1;                                              // 0x00C2(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      Loop : 1;                                                 // 0x00C2(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	...
	unsigned char                                      UnknownData01[0x38];                                      // 0x00E8(0x0038) MISSED OFFSET
